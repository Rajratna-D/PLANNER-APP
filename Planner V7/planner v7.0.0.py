...
THEMES = {
    "dark": {
        "BG": "#07090E", "PANEL": "#0C0F18", "CARD": "#111420", "CARD2": "#161B2C",
        "HOVER": "#1C2238", "BORDER": "#1F2540", "BORDER2": "#2A3055",
        "TEXT": "#DDE3F5", "SUBTEXT": "#5E6A90", "DIM": "#2E3555",
    },
    "light": {
...
class PlannerApp(ctk.CTk):
    ...
    def _refresh_productivity(self):
        ...
        for col_i, (period, score, sessions_n, sub) in enumerate([
            ...
            pb2 = ctk.CTkProgressBar(crd, height=5, progress_color=sc, fg_color=BORDER)
